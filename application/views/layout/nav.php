  ...
  <nav class="px-nav px-nav-left">
    <button type="button" class="px-nav-toggle" data-toggle="px-nav">
      ...
      <span class="px-nav-toggle-label font-size-11">OCULTAR MENU</span>
    </button>
    ...
    <li class="px-nav-item px-nav-dropdown active">
      ...
      <li class="px-nav-item px-nav-dropdown">
        ...
        <ul class="px-nav-dropdown-menu">
        <li class="px-nav-item"><a href="<?php echo base_url('reportes/dashBoard');?>"><span class="px-nav-label">Tablero</span></a></li>
